...
public class _08_주식가격 {
    public static void main(String[] args) {
        ...
        System.out.println(getPriceNotFallPeriods(new int[]{1, 2, 3, 2, 3}));
        
        System.out.print("정답 = [6, 2, 1, 3, 2, 1, 0] / 현재 풀이 값 = ");
        System.out.println(getPriceNotFallPeriods(new int[]{3, 9, 9, 3, 5, 7, 2}));
        
        System.out.print("정답 = [6, 1, 4, 3, 1, 1, 0] / 현재 풀이 값 = ");
        System.out.println(getPriceNotFallPeriods(new int[]{1, 5, 3, 6, 7, 6, 5}));
    }

    public static List<Integer> getPriceNotFallPeriods(int[] prices) {
        ...
        while (!pricesQueue.isEmpty()) { 
            ...
            Queue<Integer> tempQueue = new LinkedList<>(pricesQueue);
            
            for (int nextPrice : tempQueue) {
